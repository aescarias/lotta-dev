    ...
    <xsl:template match="/">
        ...
        <body>
            ...
            <header class="rss-notice">
                <p>
                    This is an <a href="https://aboutfeeds.com/">RSS feed</a> meant for
                    feed readers and aggregators. Copy the URL from the address bar into
                    your favorite reader and enjoy the freedom of web syndication!
                </p>
            </header>
                    ...
                    <xsl:for-each select="/rss/channel/item">
                        <article class="post">
                            <time>
                                ...
                                <!-- I don't like this hack but webbrowsers barely support XSLT 1.0, let alone 2.0 -->
